    ...
    <hr>
      ...
      <div class="form-group">
       <input type="text" class="form-control" name="firstname" placeholder="Firstname" value="<?php echo $user['firstname'] ?>" required>
          ...
          <div class="form-group">
       <input type="text" class="form-control" name="middlename" placeholder="Middlename" value="<?php echo $user['middlename'] ?>" required>
      </div>    
      <div class="form-group">     
          <input type="text" class="form-control" name="lastname" placeholder="Lastname"value="<?php echo $user['lastname'] ?>" required>
        </div>
      <div class="form-group">
      <input type="text" class="form-control" name="school" placeholder="School" value="<?php echo $user['school'] ?>" required>
    </div>
    <div class="form-group">
       <input type="text" class="form-control" name="program" placeholder="Course" value="<?php echo $user['program'] ?>" required>
      </div>     
      <div class="form-group">     
          <input type="text" class="form-control" name="yearlevel" placeholder="Year Level" value="<?php echo $user['yearlevel'] ?>" required>
        </div>
        <div class="form-group">     
          <input type="text" class="form-control" maxlength="13" minlength="13" name="phonenumber" placeholder="Enter contact number +63"value="<?php echo $user['phonenumber'] ?>" required>
        </div>
        <div class="form-group">
