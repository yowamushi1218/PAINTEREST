...
<div id="sidebar">
    <ul>
        ...
        <li >
            <a href="admin/Add_Costumer.php"><i class="icon icon-user"></i><span>Customer</span></a>
        </li>
        <li >
            <a href="admin/add_product.php"><i class="icon icon-file"></i><span>Products</span></a>
        </li>
        <li >
            <a href="admin/add_supplier.php"><i class="icon icon-user"></i><span>Supplier</span></a>
        </li>
        <li >
            <a href="admin/add_reports.php"><i class="icon icon-calendar"></i><span>Reports</span></a>
        </li>
        <li>
            <a href="admin/backUpRestoreData.php"><i class="icon icon-remove"></i> <span>System</span> <span
